        ...
        if not service_nodes:
            service_nodes = [
                ...
                ArchNode(
                    ...
                    files="orders.py",
                    description="Subscription processing, invoicing, receipt creation",
                ),
                ArchNode(
                    id="node-session",
                    name="Session & Token Manager",
                    type="service",
                    tech="session_service.py",
                    files="session_service.py",
                    description="Session lifecycle, token validation, rate limiting",
                ),
                ArchNode(
                    id="node-notify",
